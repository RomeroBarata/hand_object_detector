...
def vis_detections_filtered_objects_PIL(im, obj_dets, hand_dets,
                                        thresh_hand=0.8, thresh_obj=0.01, font_path='lib/model/utils/times_b.ttf'):
    # convert to PIL
    im = im[:, :, ::-1]
            ...
            if score > thresh_hand:
                ...
                if state > 0:  # in contact hand
                    ...
                    if lr == 0:
                        ...
                        side_idx = 1
                    draw_line_point(draw, side_idx,
                                    (int(hand_cc[0]), int(hand_cc[1])), (int(obj_cc[0]), int(obj_cc[1])))
    elif hand_dets is not None:
